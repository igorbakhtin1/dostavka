...
@InputType()
class FeedbackUpdateManyWithoutPerformerProfilesInput {
...
export { FeedbackUpdateManyWithoutPerformerProfilesInput as FeedbackUpdateManyWithoutPerformerProfilesInput };
